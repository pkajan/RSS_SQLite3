...
if ($SUCCESS) {
    ...
    <div class="row">
        <div class="col s6">
            <form id="linkForm" class="col s12">
                <div class="row padding10">
                    <div id="linkForm_name_DIV" class="input-field outlined col s12" style="margin: 0 4px;">
                ...
                <div class="row padding10">
                    <div id="linkForm_link_DIV" class="input-field outlined col s12" style="margin: 0 4px;">
        ...
        <div class="col s6 center-vertical">
            <div class="row">
                <div class="col s4">
